...
class Produto(ABC):
    def __init__(self, nome: str, preco_custo: float) -> None:  # noqa: B027 - hook que o aluno implementa
        ...

    @property  # noqa: B027 - hook que o aluno implementa
    def nome(self) -> str: ...
    ...
    def __repr__(self) -> str:  # noqa: B027 - hook que o aluno implementa
        ...
